...
const IMPLICATIONS = [
  {
    keywords: ["correspondent bank", "microfinance bank", "pension fund", "insurance company", "interbank"],
    why:
      "This is about the institutions you actually deal with in FIIO — other banks, MFBs, insurers, pension funds. It could signal a new counterparty risk, a partnership opportunity, or a regulatory change affecting how you work with them.",
  },
  {
    keywords: ["development finance", "multilateral", "african development bank", "afdb", "ifc", "world bank"],
    why:
      "Development finance institutions and multilaterals are core FIIO relationships — they often co-finance large deals or provide credit lines banks like Ecobank draw on. News here can signal new funding available for your clients' projects.",
  },
  {
