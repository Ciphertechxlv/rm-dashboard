...
export const STUDY_TOPICS = [
  {
    ...
    points: [
      ...
      "Correspondent banking relationships require ongoing AML/KYC due diligence — including periodic review of the correspondent's ownership, licensing, and sanctions exposure. The industry-standard tool for this is the Wolfsberg CBDDQ (Correspondent Banking Due Diligence Questionnaire).",
      "De-risking is a real, ongoing challenge in this space — banks terminating or restricting correspondent relationships (often by country or sector) to cut compliance risk rather than manage it. Worth watching for at a portfolio level, not just per-relationship.",
      ...
      "Full glossary of correspondent banking terms (Loro accounts, RTGS vs net settlement, SSIs, value dates, cut-off times, and more) is on the Reference page.",
    ],
