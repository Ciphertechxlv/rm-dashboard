...
export const CBN_RATES = {
  ...
  liquidityRatio: 30.0,
  // Inflation is no longer tracked here — it's fetched live from NBS
  // (see pages/api/inflation.js and components/LiveInflation.js), since
  // that source is genuinely scrapable and updates without manual edits.
