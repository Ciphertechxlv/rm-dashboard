...
export const OUTLOOK_SETUP = [
  { setting: "Default font", value: "Aptos, size 12" },
  { setting: "Line spacing", value: "1.5 lines" },
  { setting: "Default reply action", value: "Reply (not Reply All) — deliberate Reply All only" },
  { setting: "Always show Bcc", value: "On — available when needed, used deliberately" },
  { setting: "Always show From", value: "Off, unless managing a shared/team mailbox" },
];
