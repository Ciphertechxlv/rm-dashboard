...
export const FIIO_TEAM = [
  ...
  { name: "Ini", role: "Insurance — also supervises Tumininu & Emmanuel's support routing" },
  { name: "Omolaja", role: "Manages Custodian Asset Management" },
...
// How client/customer handling is actually routed day-to-day — mainly
// support work: email confirmations and backup coverage.
export const FIIO_ROUTING = [
  {
    owners: "Folakemi & Praise's clients",
    handledBy: "Tumininu",
    supervisedBy: "Ini",
  },
  {
    owners: "Mr Laj & Ini's clients",
    handledBy: "Emmanuel",
    supervisedBy: "Ini",
  },
  {
    owners: "Mr Omolaja's confirmations",
    handledBy: "Tumininu",
    supervisedBy: "Ini",
  },
];
