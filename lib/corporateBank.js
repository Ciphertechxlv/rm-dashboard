...
export const FIIO_REAL_SUBUNITS = [
  {
    ...
    owner: "Folakemi",
    examples: "Deutsche Bank, Citibank, Access Bank UK, Absa, Nedbank, and other non-Nigerian international banks",
  },
  {
    name: "Fintechs",
    owner: "Praise",
    examples: "OPay, Kuda, Moniepoint, and similar",
  },
  {
    name: "Insurance",
    owner: "Ini",
    examples: "Insurance companies (part of NBFI coverage)",
  },
  {
    name: "Mortgages",
    owner: "Folakemi",
    examples: "Jubilee Life Mortgage, FT Mortgage, Abbey Mortgage, and similar",
  },
  {
    name: "Asset Management",
    owner: "Mr Laj",
    examples: "Asset managers, pension companies (part of NBFI coverage)",
  },
];
...
export const FIIO_CLIENT_CATEGORIES = [
  ...
  },
  {
    ...
    examples: "AFC, IFC, EBRD, EPID",
  },
  {
    category: "Non-Banking Financial Institutions (NBFI)",
    examples: "Asset managers, insurance companies, pension companies",
  },
];
